...
$schuelerId = isset($_POST['search']) ? intval($_POST['search']) : null;
$date = isset($_POST['date']) ? $_POST['date'] : null;

// Validierung der Eingaben
if ($schuelerId === null || empty($date)) {
    echo json_encode(["error" => "Ungültige Eingaben. Bitte geben Sie eine Schüler-ID und ein Datum ein."]);
    exit;
}

// Prozedur aufrufen
$sql = "{CALL dbo.HistoryS(?, ?)}";
